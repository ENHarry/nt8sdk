...
echo [5/5] Copying DLL to NinjaTrader Custom folder...
...
echo ========================================================================
echo.
echo DLL Location: %USERPROFILE%\Documents\NinjaTrader 8\bin\Custom\NT8PythonAdapter.dll
echo.
echo Next steps:
echo   1. RESTART NinjaTrader 8
echo   2. Check Tools -^> Output Window for: "Python adapter waiting for connection..."
echo   3. Run your Python trading bot
echo.
echo ========================================================================
echo.
